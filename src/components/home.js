		...
		return(
			<section className="App">
				...
				<ul className="App-article-list">
					...
					<li>ES6</li>
					<li>Usage of <a href="https://github.com/typicode/json-server" target="_blank" rel="noopener noreferrer">json-server</a> backend api to perform CRUD actions</li>
					<li>Usage of <a href="https://github.com/ReactTraining/react-router" target="_blank" rel="noopener noreferrer">react router</a> for routing</li>
					<li>Usage of <a href="https://github.com/reactjs/react-redux" target="_blank" rel="noopener noreferrer">react redux</a> to maintain application state</li>
				</ul>
				</article>
